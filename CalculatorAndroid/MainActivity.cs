...
namespace CalculatorAndroid
{
    ...
    public class MainActivity : AppCompatActivity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            _calculatorText = FindViewById<TextView>(Resource.Id.calculatorTextView);
        }
        ...
        private void UpdateCalculatorText() => _calculatorText.Text = $"{numbers[0]} {@operator} {numbers[1]}";
